...
const signUpSchema = z.object({
  ...
  role: z.enum(['customer', 'seller', 'driver', 'property_seller']),
...
const passwordRequirements = [
  { text: 'At least 12 characters', regex: /.{12,}/ },
...
export default function SignUpPage() {
  ...
  const signUpWithGoogle = async () => {
    if (isMockMode) {
      toast.error('Google Sign-Up not available in mock mode. Use email/password.');
      return;
    }
  ...
  const getPasswordStrength = (password: string) => {
    ...
    const passedRequirements = passwordRequirements.filter(req => req.regex.test(password)).length;
      ...
      >
        ...
        <div className="mt-8 space-y-6">
          ...
          >
            ...
            {isMockMode ? 'Google Sign-Up (Unavailable in Mock Mode)' : 'Sign up with Google'}
          </button>
              ...
              <div className="flex">
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-blue-700">
                    <p>Fill out the form to create a demo account</p>
                    <p>No real registration required in demo mode</p>
                  </div>
                </div>
              </div>
            </div>
